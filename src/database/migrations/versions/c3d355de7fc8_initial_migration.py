...
Revision ID: c3d355de7fc8
Revises: 
Create Date: 2025-06-05 17:12:05.456606
...
def upgrade() -> None:
    ...
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('uuid_movie', sa.UUID(), nullable=False),
    ...
    sa.UniqueConstraint('uuid_movie')
    )
