...
@router.delete("/stars/{star_id}/", dependencies=[Depends(require_admin)])
...
@router.delete("/directors/{director_id}/", dependencies=[Depends(require_admin)])
...
@router.delete("/certifications/{certification_id}/", dependencies=[Depends(require_admin)])
...
@router.delete("/movies/{movie_id}/", dependencies=[Depends(require_admin)])
